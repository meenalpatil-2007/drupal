...
<div class="col-sm-12 col-md-12 col-lg-12">
	<div class="panel panel-default">
		<div class="panel-heading">Profile Details</div>
			...
			<div class="col-sm-6 col-md-6 col-lg-6">
				...
				<img src="http://drupal-7.41.dev/sites/default/files/<?php echo $content['field_profile_img'][0]["#item"]["filename"]; ?>" class="img-responsive" width="150px"
	...
	<div class="panel-heading">Contact Details</div>
		<div class="panel-body">
		<div class="col-sm-6 col-md-6 col-lg-6">
			<b><?php print render($content['field_living_location']['#title']);?></b>&nbsp;:&nbsp;<?php print render($content['field_living_location'][0]['#markup']); ?>
		</div>
		<div class="col-sm-6 col-md-6 col-lg-6">
